...
# Использовать формулу: длинаширинамасса асфальта для покрытия одного кв метра дороги асфальтом, толщиной в
...
class Road:
    ...
    def volumeofasphalt(self):
        return float(self._length * self._width * 25 * 5 /1000)


a = Road(20, 5000)

print(f"Масса асфальта {a.volumeofasphalt()} тонн")
